...
def main():
    ...
    ap = AudioProcessor()
    fileName = "PinkPanther30.wav" # "Recorded_audio.wav" "PinkPanther30.wav"
    ...
    ap.plot_wav_file(os.path.join(BASE_DIR,fileName),name=fileName)
    
    # record an audio
    # res = ap.record_audio(record_path)
    # ap.plot_wav_file(res,name=recordName)
    ap.play_recorded_audio(BASE_DIR,fileName)
